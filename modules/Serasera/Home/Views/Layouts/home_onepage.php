...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">Serasera.org</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#about">
              <?php echo lang('Home.about') ?>
            </a></li>
          <li><a class="nav-link scrollto" href="#services">
              <?php echo lang('Home.sites') ?>
            </a></li>
          <li><a class="nav-link scrollto o" href="#stats">
              <?php echo lang('Home.stats') ?>
            </a></li>
          <?php
          /* 
          ...
          */
          ...
          <li><a class="nav-link scrollto" href="#contact">
              <?php echo lang('Home.contact') ?>
            </a></li>
          <li><a class="getstarted scrollto" href="#about">
              <?php echo lang('Home.signup') ?>
            </a></li>
        </ul>
